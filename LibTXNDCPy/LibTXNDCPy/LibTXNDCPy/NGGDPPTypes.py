...
# This file is automatically generated by generateDS, and serves as the connection between Python and the XML.  It's where the proverbial magic happens.
# Do not make changes to this file by hand.  If the XML schema is updated, a new version must be generated using generateDS.
